...
<?php echo $this->Form->create('Tenencia');?>
	<fieldset>
		<legend><?php __('Edit Tenencia'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Tenencia.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Tenencia.id'))); ?></li>
