<div class="estadosSaluds index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('otra_enfermedad');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $estadosSalud['EstadosSalud']['altura']; ?>&nbsp;</td>
		...
		<td><?php echo $estadosSalud['EstadosSalud']['otra_enfermedad']; ?>&nbsp;</td>
