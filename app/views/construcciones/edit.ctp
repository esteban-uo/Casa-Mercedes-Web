...
<?php echo $this->Form->create('Construccion');?>
	<fieldset>
		<legend><?php __('Edit Construccion'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Construccion.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Construccion.id'))); ?></li>
