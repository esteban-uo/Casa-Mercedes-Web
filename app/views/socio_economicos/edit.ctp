...
<?php echo $this->Form->create('SocioEconomico');?>
	<fieldset>
		<legend><?php __('Edit Socio Economico'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('SocioEconomico.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('SocioEconomico.id'))); ?></li>
