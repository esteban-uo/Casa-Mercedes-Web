...
<?php echo $this->Form->create('Zona');?>
	<fieldset>
		<legend><?php __('Modificar Zona'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Eliminar', true), array('action' => 'delete', $this->Form->value('Zona.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Zona.id'))); ?></li>
